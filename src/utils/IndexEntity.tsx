...
import RecordsPerPageSelect from './RecordsPerPage';
import Pagination from './Pagination';
import GenericList from './GenericListComponent';
    ...
    function loadData() {
        axios.get(props.url, {
            params: { page, recordsPerPage }
             ...
             parseInt(response.headers['totalamountofrecords'] as string, 10);
